<?php
if (!defined('CMS2CMS_JOOMLA_VERSION')) {
    die();
}

$dataProvider = new CmsPluginFunctionsJoomla();
$dataProvider->logOut();

$key              = get_option('cms2cms-joomla-key');
$activated        = $dataProvider->isActivated();
$targetUrl        = get_site_url();
$authentication   = $dataProvider->getAuthData();
$ajaxNonce        = $dataProvider->getFormTempKey('cms2cms-joomla-ajax-security-check');
$currentPluginUrl = plugin_dir_url(__FILE__);
$jsConfig         = $dataProvider->getConfig(true);
$config           = $dataProvider->getConfig();
$loader           = new CmsBridgeJoomlaLoader();

$styles = array($dataProvider->getFrontUrl() . 'css/cms2cms.css?v=' . CMS2CMS_JOOMLA_VERSION);
foreach ($styles as $style) {
    printf('<link rel="stylesheet" href="%s" type="text/css" media="all">', $style);
}

$scripts = array(
    $dataProvider->getFrontUrl() . 'js/jsonp.js?v=' . CMS2CMS_JOOMLA_VERSION,
    $dataProvider->getFrontUrl() . 'js/cms2cms.js?v=' . CMS2CMS_JOOMLA_VERSION
);
...
?>
<div class="wrap cms2cms-joomla-wrapper">
            ...
            <div class="cms2cms-joomla-message">
                <span>
                    <?php echo sprintf(
                        ...
                        get_option('cms2cms-joomla-login')
                    ); ?>
                </span>
                <div class="cms2cms-joomla-logout">
                    <form action="" method="post" id="logout" data-logout="<?php echo $dataProvider->getLogOutUrl() ?>">
                        ...
                        <input type="hidden" name="_wpnonce"
                               value="<?php echo $dataProvider->getFormTempKey('cms2cms_joomla_logout') ?>"/>
            ...
            <div id="cms2cms_joomla_accordeon">
                        ...
                        <form action="<?php echo $dataProvider->getLoginUrl() ?>"
                            ...
                            <div class="center-content">
                                ...
                                <div class="user-name-block" style="display: none">
                                    <label
                                            for="cms2cms-joomla-user-name"><?php $dataProvider->_e('Full Name', $fileStart); ?></label>
                                ...
                                <div>
                                    <label
                                            for="cms2cms-joomla-user-email"><?php $dataProvider->_e('Email', $fileStart); ?></label>
                                ...
                                <div>
                                    <label
                                            for="cms2cms-joomla-user-password"><?php $dataProvider->_e('Password', $fileStart); ?></label>
                                ...
                                <a data-log-this="Forgot Password Link clicked"
                                   ...
                                   class="cms2cms-joomla-real-link" >
                ...
                <div id="cms2cms_joomla_accordeon_item_id_<?php echo $cms2cms_joomla_step_counter++; ?>"
                    ...
                    <form action="<?php echo $dataProvider->getWizardUrl(); ?>"
                          method="post"
                          id="cms2cms_joomla_form_estimate">
                        <div class="center-content">
                            <div class="error_message"></div>
                            <div id='error'></div>
                            ...
                            <div>
                                ...
                                <input type="text" id="sourceUrl" name="sourceUrl" value="" class="regular-text"
                                       ...
                                       ?>"/>
                                <div class="cms2cms-joomla-error">
                                    <div class="error-arrow"></div>
                                    <span></span></div>
                            </div>
                            ...
                            <input type="hidden" id="key" name="key"
                                   value="<?php echo $key; ?>"/>
                            <button id="verifySource_joomla"
                                    data-log-this="Verify Source Button pressed"
                                    type="button" name="verify-source" class="cms2cms-joomla-button button-green">
