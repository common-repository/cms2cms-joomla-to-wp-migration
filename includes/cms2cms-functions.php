...
/**
 * Class CmsPluginFunctionsJoomla
 */
class CmsPluginFunctionsJoomla
{
    ...
    private $jsConfig = '{
        ...
        "joomlaExtension" : "https://cms2cms.com/files/joomla/cms2cmsconnector/com_cms2cmsconnector.zip",
    ...
    {
        $cms2cms_joomla_access_login = get_option('cms2cms-joomla-login');
        $cms2cms_joomla_access_key   = get_option('cms2cms-joomla-key');

        return array(
            'email'     => $cms2cms_joomla_access_login,
            'accessKey' => $cms2cms_joomla_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_joomla_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-joomla-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-joomla-key', $key);

            delete_option('cms2cms-joomla-login');
            add_option('cms2cms-joomla-login', $login);

            delete_option('cms2cms-joomla-depth');
            add_option('cms2cms-joomla-depth', $bridge_depth);
    ...
    {
        return $this->__('Joomla', 'cms2cms-joomla-migration');
    }
    ...
    {
        return $this->__('WordPress', 'cms2cms-joomla-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-joomla-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-joomla-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_joomla_logout')
                && $_POST['cms2cms_joomla_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }        
